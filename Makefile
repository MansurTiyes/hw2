...
OBJS=amazon.o mydatastore.o user.o db_parser.o clothing.o movie.o book.o product.o product_parser.o util.o
...
amazon.o: amazon.cpp mydatastore.h clothing.h movie.h book.h db_parser.h datastore.h product_parser.h 
	$(CXX) $(CXXFLAGS) $(DEFS) -o $@ -c amazon.cpp
mydatastore.o: mydatastore.cpp mydatastore.h datastore.h user.h util.h product.h movie.h book.h clothing.h 
